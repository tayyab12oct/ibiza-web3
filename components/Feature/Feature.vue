              ...
              >
                <div class="desc">
                  ...
                  <div :class="[isMobile ? 'text-center' : 'text-right']">
                    <v-btn color="primary" large class="btn" href="https://nft.ibizatoken.com/">
                      {{ $t('saasLanding.see_detail3') }}
                    </v-btn>
                  </div>
                </div>
              </u-animate>
                ...
                <div class="desc">
                  <title-main :align="isMobile ? 'center' : 'right'">
                    <span>
                      {{ $t('saasLanding.feature_title1') }}
                      <strong>
                        {{ $t('saasLanding.feature_titlestrong4') }}
                      </strong>
                    </span>
                  </title-main>
                  <h6 class="use-text-subtitle2" :class="[isMobile ? 'text-center' : 'text-right']">
                    {{ $t('saasLanding.feature_desc4') }}
                  </h6>
                  <div :class="[isMobile ? 'text-center' : 'text-right']">
          ...
          <v-row class="spacing6">
            ...
            <v-col md="10" cols="12" class="pa-6">
              ...
              >
                ...
                <v-tab class="tab-label" href="#tab-1">IBZ Collection</v-tab>
                <v-tab class="tab-label" href="#tab-2">Artists Collection</v-tab>
                <v-tab class="tab-label" href="#tab-3">Brand Collection</v-tab>
